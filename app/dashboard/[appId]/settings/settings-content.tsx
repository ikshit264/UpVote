...
import { Copy, Check, Code2, Settings2, MessageSquare, BookOpen } from 'lucide-react';
import {
    Select,
    SelectContent,
    SelectItem,
    ...
    return (
        <div className="p-8 space-y-8 max-w-5xl mx-auto">
            ...
            <Tabs defaultValue="settings" className="w-full">
                <TabsList className="grid grid-cols-2 w-full max-w-md bg-zinc-100 dark:bg-zinc-800 p-1 rounded-xl">
                    <TabsTrigger value="settings" className="rounded-lg">
                        <Settings2 className="w-4 h-4 mr-2" />
                        Settings
                    </TabsTrigger>
                    <TabsTrigger value="integration" className="rounded-lg">
