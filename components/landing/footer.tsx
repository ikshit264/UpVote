            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-zinc-500 dark:text-zinc-400">
                        ...
                        <li><Link href="/#features" className="hover:text-blue-600 transition-colors">Integrations</Link></li>
                        <li><Link href="/#pricing" className="hover:text-blue-600 transition-colors">Pricing</Link></li>
                        <li><Link href="/blogs" className="hover:text-blue-600 transition-colors">Changelog</Link></li>
                    </ul>
                </div>
